...
You need to install the gRPC PHP protoc plugin to generate the client stub
classes.

Note: You don't need to do this if you had compiled the gRPC C core from
source, i.e. if you had run `make` from the root directory from this repo.

Also, we hope to provide a better way to download and install the plugin
in the future.
